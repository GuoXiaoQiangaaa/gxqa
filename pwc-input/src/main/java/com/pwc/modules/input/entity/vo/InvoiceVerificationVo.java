...
/**
 * @description: 发票验真导出数据
 * @author: Gxw
 * @create: 2020-09-17 09:42
 **/
@Data
public class InvoiceVerificationVo {
    /** 发票代码 */
    ...
    /**总金额（含税）*/
    @ExcelField(title="总金额（含税）", align=1, sort=100)
    private BigDecimal invoiceTotalPrice;
    /**总金额（不含税）*/
    @ExcelField(title="总金额（不含税）", align=1, sort=110)
    private BigDecimal invoiceFreePrice;
    /**总税额*/
    @ExcelField(title="总税额", align=1, sort=120)
